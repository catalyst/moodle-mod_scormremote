...
$string['debugloglevel'] = 'Debugging log level';
$string['debuglogleveldescription'] = 'When the log level is set it emits logs into the browser developer tools using console.log';
