...
$string['manage_additionalclientdomain'] = 'Additional client domains';
$string['manage_alloweddomains'] = 'Additional domains';
...
$string['privacy:metadata'] = 'The scorm remote module does not store any personal data.';
